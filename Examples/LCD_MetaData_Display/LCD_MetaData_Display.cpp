...
#define REFRESH_RATE 350            //rate at which the screen updates (for scrolling)
#define SCROLL_WAIT 2000            //rate at which a string stays still before it starts scrolling
#define LOCATION "11 GrevilleClose"    //location to display on splash screen while disconnected
...
RN52 rn52(12,13);  //set RX to pin 10 and TX to pin 11 on Arduino (other way round on RN52)
